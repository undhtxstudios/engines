...
function loadScene(_scene) {
  ...
  if (scene == 0) {
    ...
    for (let i = 500; i--; ) spawnRandomObject(vec2(rand(1, 39), rand(10, 50)));
  }
  if (scene == 1) {
    sceneName = "Pyramid";
  ...
  if (scene == 6) {
    sceneName = "Joints";
    {
      ...
      const l1 = new EngineObject(vec2(20, 8), vec2(39, 0.5), 0, 0, GRAY);
      const l2 = new EngineObject(vec2(20, 50), vec2(0.5, 99), 0, 0, GRAY);
    ...
    }
    {
      ...
      const oA = new PulleyJointObjects(
        vec2(15, 8),
        vec2(1, 2),
        randColor(),
        anchorA
      );
      const oB = new PulleyJointObjects(
        vec2(25, 8),
        vec2(1, 2),
        randColor(),
        anchorB
      ...
      const line = new EngineObject(vec2(20, 15), vec2(10, 0.2), 0, 0, BLACK);
      line.gravityScale = 0;
      line.renderOrder = -1;
    }
    {
  ...
  if (scene == 7) {
    ...
    for (let i = 200; i--; ) spawnRandomObject(vec2(rand(1, 39), rand(10, 50)));
  }
  if (scene == 8) {
    sceneName = "Mobile";
