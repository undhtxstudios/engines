# All credits to https://www.youtube.com/watch?v=8PtKtyK-iVg
...
if __name__ == '__main__':
    pygame.init()
    pygame.display.set_caption('Shadows, Overlays, etc')

    screen = pygame.display.set_mode((500, 500))

    clock = pygame.time.Clock()

    img = pygame.image.load('shape.png')
    img.set_colorkey((0, 0, 0))
    img_2 = pygame.image.load('rotated_shape.png')
